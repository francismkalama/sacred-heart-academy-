...
//    @Column(name = "fees_id")
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "fees_gen_seq")
    @SequenceGenerator(name = "fees_gen_seq", sequenceName = "fees_gen_seq", allocationSize = 1, initialValue = 1)
    @Column(name = "fees_id")
    private long feeId;
